...
Step 4: **Move** the shapes into order from top to bottom. Place "Start", "Open assignment", "Finish work", and "Work complete?" in one vertical line. Place "Submit assignment" to the right of the decision shape, and place "End" below it.
...
Step 6: **Connect** "Start" to "Open assignment" by hovering over the middle of the bottom outline of "Start", then **clicking and dragging** it to the top outline of "Open assignment".
