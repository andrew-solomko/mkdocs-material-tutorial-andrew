...
!!! success
    Your rectangle should now have round edges instead of the default sharp edges.
...
!!! warning
    Double-clicking on the grouped object will select only one of them, when you want to move grouped objects, click once.
